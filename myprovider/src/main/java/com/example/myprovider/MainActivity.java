...
public class MainActivity extends AppCompatActivity implements AutoPermissionsListener {
    ...
    Button btnCall, btnContact, btnAdd;
    EditText edtCall,txtName, txtEmail;
...
//                        Manifest.permission.READ_CONTACTS}, MODE_PRIVATE);
        ...
        btnCall.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { edtCall.setText(getCallHistory()); }
        });
    ...
    public void addContact(){
        ...
        intent.putExtra(ContactsContract.Intents.Insert.EMAIL, txtEmail.getText())
                ...
                .putExtra(ContactsContract.Intents.Insert.PHONE, "010-222-555")
    ...
    public String getCallHistory() {
        //callSet 필요한 거???? DATE,TYPE,NUMBER,DURATION 등등
        //컬럼 정보 PROJECTION ??
        ...
        //db정보를 읽는 것?
        //CallLog.Calls.CONTENT_URI을 쿼리로 넘겨주는 거?
        //selection 조건?
        //db 정보를 c에 담아서
